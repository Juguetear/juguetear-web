...
export const Checkbox = ({ label, id, ...props }: CheckboxProps) => {
  ...
  const labelStyle =
    "z-10 text-blue text-sm font-outfit ml-2 peer-checked:text-orange font-medium hover:cursor-pointer peer-disabled:text-gray-dark peer-disabled:font-medium";
